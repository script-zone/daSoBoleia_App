...
export function RegistarViatura() {
  const [{ matricula, marca, modelo, lotacao }, setFormRegisterCar] = useState({
    matricula: "",
    marca: "",
    modelo: "",
    lotacao: 0,
        ...
        <SafeAreaView className="flex-1">
          <KeyboardAwareScrollView className="flex-1">
            ...
            <View className="ml-2 mt-12">
              <ButtonBack action={() => goBack()} />
            </View>
            <View className="mx-5">
              <Text className="text-3xl text-white font-roboto700Bold">
                Registar Viatura
              </Text>
              <Text className="text-white500 text-xs mt-2">
                Registe uma Viatura para poder participar nas BOLEIAS{" "}
              </Text>
              <Text className="text-white500 text-xs mb-4">
                como condutor e faturar um KÚMBU!
              </Text>
            </View>
