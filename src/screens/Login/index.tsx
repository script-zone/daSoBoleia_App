                ...
                <View className='flex-1 rounded-t-3xl bg-white500 items-center justify-center p-8 opacity-95' >
                    ...
                    <View className='w-full items-center '>
                        ...
                        <View className='w-full h-12 relative border-2 border-gray800 rounded-md flex-row focus:border-green'>
                            ...
                            />
                            <Pressable className='items-center absolute top-0 right-0 justify-center w-[15%] h-full rounded-br-md ' onPress={() => setVerSenha(!verSenha)}>
                    ...
                    <View className='w-full items-center '>
                        <StyledButton name={'Conecte-se'} action={() => navigation.navigate('principal')} />
